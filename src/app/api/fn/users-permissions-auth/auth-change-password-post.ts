...
export function authChangePasswordPost(http: HttpClient, rootUrl: string, params: AuthChangePasswordPost$Params, context?: HttpContext): Observable<StrictHttpResponse<UsersPermissionsUserRegistration>> {
...
authChangePasswordPost.PATH = '/auth/change-password';
