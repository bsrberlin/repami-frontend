...
export function getLanguages(http: HttpClient, rootUrl: string, params?: GetLanguages$Params, context?: HttpContext): Observable<StrictHttpResponse<LanguageListResponse>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<LanguageListResponse>;
    })
  );
}
