...
export interface GetNavigationselements$Params {
...
export function getNavigationselements(http: HttpClient, rootUrl: string, params?: GetNavigationselements$Params, context?: HttpContext): Observable<StrictHttpResponse<NavigationselementListResponse>> {
  const rb = new RequestBuilder(rootUrl, getNavigationselements.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NavigationselementListResponse>;
    })
  );
}

getNavigationselements.PATH = '/navigationselements';
