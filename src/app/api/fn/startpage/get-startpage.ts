...
export interface GetStartpage$Params {
...
export function getStartpage(http: HttpClient, rootUrl: string, params?: GetStartpage$Params, context?: HttpContext): Observable<StrictHttpResponse<StartpageResponse>> {
  const rb = new RequestBuilder(rootUrl, getStartpage.PATH, 'get');
  if (params) {
