...
export function getProfiles(http: HttpClient, rootUrl: string, params?: GetProfiles$Params, context?: HttpContext): Observable<StrictHttpResponse<ProfileListResponse>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<ProfileListResponse>;
    })
  );
}
