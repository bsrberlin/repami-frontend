...
export interface GetStartseites$Params {
...
export function getStartseites(http: HttpClient, rootUrl: string, params?: GetStartseites$Params, context?: HttpContext): Observable<StrictHttpResponse<StartseiteListResponse>> {
  const rb = new RequestBuilder(rootUrl, getStartseites.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<StartseiteListResponse>;
    })
  );
}

getStartseites.PATH = '/startseites';
