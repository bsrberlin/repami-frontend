...
import { TestListResponse } from '../../models/test-list-response';

export interface GetTests$Params {
...
export function getTests(http: HttpClient, rootUrl: string, params?: GetTests$Params, context?: HttpContext): Observable<StrictHttpResponse<TestListResponse>> {
  const rb = new RequestBuilder(rootUrl, getTests.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<TestListResponse>;
    })
  );
}
